...
interface Props {
  results: University[];
  searched: boolean;
  filters: { country: string; cgpa: string; ielts: string };
  onBack: () => void;
}

export default function ResultsList({ results, searched, filters, onBack }: Props) {
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      ...
      <div style={{
        ...
        <motion.button
          ...
          style={{
            ...
            fontFamily: 'inherit', border: `1.5px solid ${N.border}`,
        ...
        <span style={{ color: N.dim, fontSize: 12, fontWeight: 700, textTransform: 'uppercase' as const, letterSpacing: '1px' }}>
          Active Filters
        </span>
      ...
      {results.length === 0 ? (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
          ...
          <p style={{ color: N.navy, fontSize: 22, fontWeight: 900, margin: '0 0 10px' }}>
            No universities found
          </p>
          <p style={{ color: N.dim, fontSize: 15 }}>
        ...
        <>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
            ...
            <div style={{
              ...
              padding: '6px 18px', borderRadius: 50, background: '#ffffff',
          ...
          <div style={{
            ...
            background: 'rgba(37,99,176,0.04)', border: '1px dashed rgba(37,99,176,0.18)',
            display: 'flex', alignItems: 'center', gap: 10,
          }}>
            <span style={{ fontSize: 16 }}>💡</span>
            <p style={{ fontSize: 12, color: N.dim, fontWeight: 600, margin: 0 }}>
              Click <strong style={{ color: N.blueBright }}>View Details</strong> on any card to explore Fields & Subjects and refine your choice.
            </p>
          </div>
